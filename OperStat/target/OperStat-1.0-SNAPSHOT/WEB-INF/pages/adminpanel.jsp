                    ...
                    <div class="tab-content">
                        <div id="panel1" class="tab-pane fade in active">
                            <%
                                ...
                                if (!"null".equals(line) && !"".equals(line)) query1 += "and line = '" + line + "' ";
